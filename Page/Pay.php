...
$sqlInsert = "INSERT INTO reservations (userName, eventName,eventDescription,img,price,guideName, reservationsTime)
VALUES ('$userName', '$eventName', '$eventDescription','$img','$price','$guideName' ,'$date')"; 
                      ...
                      <div class="table-responsive">
                          <table class="table shoping-cart-table">
                              ...
                              <tr>
                                  <td >
                                      <div >
                                        <img width="100" src="<?php echo" $show[img]"; ?>">
                                      </div>
                                  </td>
                                  <td class="desc">
                                      <h4>
                                      <a href="#" class="text-navy">
                                      <?php echo" $show[eventName]"; ?>
                                      </a>
                                      </h4>
                                      <p class="small">
                                      <?php echo" $show[eventDescription]"; ?>
                                      </p>
